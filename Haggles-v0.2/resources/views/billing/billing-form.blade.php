...
<div class="container" style="margin-top:3%;margin-bottom:3%;">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			value="{{ $validate == 1 ? Auth::user()->billing->billing_address : ' ' }}">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<textarea id="otherNote" class="form-control" rows="5" placeholder="Notes about your order, e.g. 
			special notes for delivery.">{{ $validate == 1 ? Auth::user()->billing->billing_note : ' ' }}</textarea>
		</div>
	</div>
	<!-- end right side -->
</div>
...
<div class="row" style="margin-top:2%;">
	<div class="col-md-12">
		<button type="button" class="btn btn-default red-btn" data-placeOrder="{{request()->route('billing')}}" data-result="buyer">
		Submit</button>
	</div>
</div>
</div>
